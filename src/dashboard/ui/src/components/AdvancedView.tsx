...
/**
 * AdvancedView — the full-featured dashboard.
 * Lifts the core App.tsx logic into a standalone component
 * so it can be swapped in/out by AppShell.
 */
export default function AdvancedView() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: 'var(--bg)', display: 'flex', flexDirection: 'column' }}>
      {/* Masthead with ViewToggle injected on right side */}
      <div style={{ position: 'relative' }}>
        ...
        />
        {/* ViewToggle overlay on masthead right — positioned absolute so it overlays without breaking Masthead layout */}
        <div style={{
          position: 'absolute',
          top: '50%',
          right: '220px',
